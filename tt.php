...
require_once('lib/binary.class.php');
require_once('lib/git_object.class.php');
require_once('lib/git_blob.class.php');
require_once('lib/git_commit.class.php');
require_once('lib/git_commit_stamp.class.php');
require_once('lib/git_tree.class.php');
...
class Git
{
     ...
     */
    public function findPackedObject($object_name)
    {
  ...
  public function getBranches() {
    $branches = get_files(sprintf('%s/%s', $this->dir, 'refs/heads/'), null, true);
    for ($i = 0; $i < count($branches); $i++) {
      $branches[$i] = str_replace(sprintf('%s/%s', $this->dir, 'refs/heads/'), '', $branches[$i]);
    }
    return $branches;
  } //getBranches
